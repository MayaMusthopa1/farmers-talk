<fieldset>
	...
	$sql = mysql_query("select * from tb_informasi where id = '$kdinformasi'") or die (mysql_error());
	...
	if($edit_produk){
		if($judul== "" || $nama_gambar=="" || $deskripsi==""){
			...
			if ($nama_gambar ==""){
					mysql_query("update tb_informasi set judul='$judul',  gambar='$nama_gambar', deskripsi='$deskripsi' where id = '$kdinformasi'") or die (mysql_error());
					?>
					<script type="text/javascript">
