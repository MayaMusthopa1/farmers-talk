<fieldset>
  ...
  <?php
  $carikode = mysql_query("select max(id) from tb_informasi") or die (mysql_error());
  ...
  if($tambah_informasi){
    if($id== "" || $judul=="" || $nama_gambar== "" || $deskripsi==""){
      ...
      if($pindah){
        mysql_query("insert into tb_informasi values ('$id', '$judul', '$nama_gambar', '$deskripsi')") or die(mysql_error());
        ?>
        <script type="text/javascript">
